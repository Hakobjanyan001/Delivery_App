...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              Text('Սխալ: ${homeProvider.error}', style: const TextStyle(color: Colors.white)),
    ...
    final filteredProducts = homeProvider.getProductsByCategory(selectedCategoryId);
    
    final displayProducts = search.isSearchActive 
      ? homeProvider.products.where((p) => p.name.getLocalized(lang).toLowerCase().contains(search.searchQuery.toLowerCase())).toList()
      : filteredProducts;
        ...
        child: CustomScrollView(
          slivers: [
            ...
            if (!search.isSearchActive && homeProvider.banners.isNotEmpty) 
              SliverToBoxAdapter(child: _buildBannersCarousel(homeProvider.banners, lang)),
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final category = isAll ? null : homeProvider.categories[index - 1];
                      final categoryId = isAll ? 'all' : category!.id;
                      final name = isAll ? l10n.translate('catAll') : category!.name.getLocalized(lang);
                      final isSelected = (selectedCategoryId == null && isAll) || (selectedCategoryId == categoryId);
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(name, style: TextStyle(color: isSelected ? Colors.black : Colors.white, fontWeight: isSelected ? FontWeight.w900 : FontWeight.bold, fontSize: 14)),
                        ),
                      );
                    },
                  ),
                      ...
                      builder: (context, constraints) {
                        ...
                        return SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              return _buildProductCard(displayProducts[index], lang);
                            },
            ...
            ClipRRect(
              ...
              child: AspectRatio(
                ...
                child: product.mainImageUrl.isNotEmpty 
                  ? Image.network(product.mainImageUrl, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => _fallbackImage())
                  : _fallbackImage(),
              ),
            ),
            Expanded(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(product.name.getLocalized(lang), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 18), maxLines: 1, overflow: TextOverflow.ellipsis),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${product.displayPrice.toStringAsFixed(0)}֏', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 18)),
                      ],
                    ),
                    const Spacer(),
                    Consumer<CartProvider>(
                      builder: (context, cart, child) {
                        ...
                        return Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () => _requireAuthOrExecute(() => cart.removeOneItemByProductId(product.id)),
                            ...
                            GestureDetector(
                              onTap: () => _requireAuthOrExecute(() => cart.addItem(product)),
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: banner.image != null ? DecorationImage(image: NetworkImage(banner.image!), fit: BoxFit.cover) : null,
            ),
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Text(banner.title.getLocalized(lang), style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700)),
                ),
                Positioned(
                  top: 80, left: 32, right: 32,
                  child: Text(banner.description.getLocalized(lang), style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 14)),
                ),
              ],
            ),
          );
