...
class LocalizationProvider with ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'hy': {
      ...
      'delivered': 'Առաքված',
      'cancelled': 'Չեղարկված',
      'freeDeliveryFrom': 'Անվճար առաքում սկսած',
      ...
      'noAddresses': 'Հասցեներ դեռ չկան',
      'cashDescription': 'Կանխիկ վճարում դռան մոտ',
      'idramDescription': 'Վճարել iDram հավելվածով',
      'addCardDescription': 'Ավելացնել բանկային քարտ',
      'howCanWeHelp': 'Ինչպե՞ս կարող ենք օգնել ձեզ',
      'callSupport': 'Զանգահարել աջակցության կենտրոն',
      'onlineChat': 'Օnline чат',
      'chatDescription': 'Գրեք մեր մասնագետին',
      'newAddress': 'Նոր հասցե',
      'addressNameHint': 'Անուն (օր.՝ Տուն, Աշխատանք)',
    ...
    'en': {
      ...
      'cashDescription': 'Cash payment at door',
      'idramDescription': 'Pay with iDram app',
      'addCardDescription': 'Add bank card',
      'howCanWeHelp': 'How can we help you?',
      'callSupport': 'Call support center',
      'onlineChat': 'Online chat',
      'chatDescription': 'Write to our specialist',
      'newAddress': 'New address',
      'addressNameHint': 'Name (e.g. Home, Work)',
    ...
    'ru': {
      ...
      'cashDescription': 'Оплата наличными при доставке',
      'idramDescription': 'Оплатить через iDram',
      'addCardDescription': 'Добавить банковскую карту',
      'howCanWeHelp': 'Как мы можем вам помочь?',
      'callSupport': 'Позвонить в центр поддержки',
      'onlineChat': 'Онлайн чат',
      'chatDescription': 'Напишите нашему специалисту',
      'newAddress': 'Новый адрес',
      'addressNameHint': 'Название (напр. Дом, Работа)',
